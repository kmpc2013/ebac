...
description: Read-only personal Q\&A skill for answering questions about the current project, repository context, configuration, and conversation state. Use when the user wants explanations, guidance, file references, or context without creating, editing, generating, or mutating anything. Keep responses concise and natural.
